...
Ok, welcome to my first tutorial! First things first we will have to create a Virtual machine using the Microsoft Azure portal. We will be using a VM which is a remote computer. We are using a VM in order to protect our physical machine just in case something breaks. Create a resource group and title it "osTicket". Afterwards create a VM with 2-4 CPUs. In this example I will be using 4 CPUs.
 ...
 <img src="https://i.imgur.com/QjtHbpZ.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
<br />
<p>
</p>
...
<img src="https://i.imgur.com/jymP4hJ.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
<br />
...
<img src="https://i.imgur.com/nYryhpZ.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>  
</p>
<p>
...
<img src="https://i.imgur.com/0m4iVmK.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
<br />
<p>
</p>
...
<img src="https://i.imgur.com/6ozYpka.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<p>
</p>
<p>
...
<img src="https://i.imgur.com/JipqF7i.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<p>
</p>
<p>
...
<img src="https://i.imgur.com/itrYdWm.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<p>
</p>
<p>
